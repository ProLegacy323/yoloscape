...
final class Texture extends DrawingArea {
	...
	public static void getItemImageSize()
	{
	...
	public static void getDistancePlayerModel(int offsetX, int offsetY)
	{
	   anIntArray1472 = new int[offsetY];
		for(int l = 0; l < offsetY; l++)
			anIntArray1472[l] = offsetX * l;

		textureInt1 = offsetX / 2;
		textureInt2 = offsetY / 2;
	}
